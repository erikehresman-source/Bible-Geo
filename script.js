...
(async function loadData(){
  try{
    ...
    const msg = "Could not load questions.json. If you opened this file directly from your computer, host it on GitHub Pages or run a local server.";
...
function resetUI(){
  ...
  mapWrapEl.classList.add("hidden"); mapEl.innerHTML=""; mapStatusEl.textContent="";
...
function showCurrent(){
  ...
  if(mapToggleEl.checked){ mapWrapEl.classList.remove("hidden"); setupMapTarget(item.map); } else { mapWrapEl.classList.add("hidden"); mapEl.innerHTML=""; mapStatusEl.textContent=""; }
}
...
function correctAnswerFlow(){
  ...
  if(mapToggleEl.checked){
    ...
    mapStatusEl.textContent="Bonus: click the map near this location.";
    return;
  }
  nextOrFinish();
}
...
function evaluateMapClick(xPct,yPct){
  ...
  document.getElementById("target-ring").style.display="block";
